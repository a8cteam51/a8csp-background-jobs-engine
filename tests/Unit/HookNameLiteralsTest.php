...
final class HookNameLiteralsTest extends TestCase {
	...
	private const HOOK_LITERALS = array(
		...
		'log'            => 'a8csp/background_tasks/log',
		'queue'          => 'a8csp/background_tasks/queue/',
		'continue_delay' => 'a8csp/background_tasks/continue_delay',
		'lock_staleness' => 'a8csp/background_tasks/lock_staleness/',
		'history_size'   => 'a8csp/background_tasks/history_size',
		'retry_policy'   => 'a8csp/background_tasks/retry_policy/',
		'misfire_grace'  => 'a8csp/background_tasks/misfire_grace/',
		'start'          => 'a8csp/background_tasks/start',
		'continue'       => 'a8csp/background_tasks/continue',
		'run'            => 'a8csp/background_tasks/run',
		'cleanup'        => 'a8csp/background_tasks/cleanup',
		'schedule_due'   => 'a8csp/background_tasks/schedule_due',
	);
