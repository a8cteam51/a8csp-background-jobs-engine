...
final readonly class LockClaimResult {
	 ...
	 * @param   int|null         $claimed_at   Generation the claim decided under, or null when no decision was reached.
	 */
	 ...
	 * @version 1.0.0
	 *
	 * @param   int $claimed_at Generation the lock was written under.
	 *
	 * @return  self
	 */
	public static function claimed( int $claimed_at ): self {
		return new self( LockClaimOutcome::Claimed, null, null, null, $claimed_at );
	}
	 ...
	 * @param   int    $claimed_at   Generation the staleness decision was made under.
	 *
	 * @return  self
	 */
	public static function contended( string $owner_run_id, string $raw, bool $stale, int $claimed_at ): self {
		return new self( LockClaimOutcome::Contended, $owner_run_id, $raw, $stale, $claimed_at );
	}
