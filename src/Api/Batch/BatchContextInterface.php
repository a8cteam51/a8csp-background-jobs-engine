...
/**
 * Gives a batch chunk controlled access to its own run.
 *
 * Queue mutations are transactional within a `BatchInterface::process_chunk()` attempt: they take
...
interface BatchContextInterface {
	 ...
	 *
	 * @throws  \InvalidArgumentException When the chunk arguments are not portable.
	 *
	 * @return  void
	 */
