 ...
 */
function a8csp_bgte_get_asset_meta( string $asset_path, ?array $extra_dependencies = null ): ?array {
	$asset_path = \str_starts_with( $asset_path, \constant( 'A8CSP_BGTE_DIR_PATH' ) ) ? $asset_path : \constant( 'A8CSP_BGTE_DIR_PATH' ) . $asset_path;
	...
	if ( '' === $asset_meta['version'] ) {
		$asset_meta['version'] = a8csp_bgte_get_plugin_version();
	}
